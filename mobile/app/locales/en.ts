const en = {
  ...
  workout: {
    ...
    session: {
      ...
      elapsedAccessibility: "Elapsed session time {{time}}",
      exerciseProgress: "Exercise {{current}}/{{total}}",
      goBack: "Go back",
      inProgress: "Workout in progress",
      loading: "Loading workout session...",
      loggingComingNext: "Logging coming next",
      sessionTime: "Session Time",
      setAccessibility: "{{set}}, {{status}}",
      setCompleted: "completed",
      setCurrent: "current",
      setLabel: "Set {{number}}",
      setOfTotal: "Set {{current}} of {{total}}",
    ...
    newPRAchieved: {
      ...
      newPRLabel: "New PR",
      previousPRLabel: "Previous PR",
      weightReps: "{{weight}} Kg x {{reps}} Reps",
      pointsLabel: "ERA Points",
      continue: "Continue",
      modalAccessibility: "New personal record achieved for {{exercise}}",
      backdropAccessibility: "Achievement overlay",
      badgeAccessibility: "Achievement badge",
      pointsAccessibility: "Plus {{points}} ERA Points awarded",
    },
    weekdays: {
      mon: "Mon",
      tue: "Tue",
