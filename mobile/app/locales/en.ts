const en = {
  ...
  auth: {
    ...
    resetLinkSent: "We sent a password reset link to {{email}}. Open it to choose a new password.",
  ...
  profile: {
    ...
    legal: {
      ...
      contactUnavailable: "We couldn't open your mail app. You can reach us at {{email}}.",
      terms: {
  ...
  progress: {
    ...
    photoPreview: {
      ...
      saveFailedTitle: "Couldn't save photo",
      saveFailedMessage: "Something went wrong while preparing the photo. Please try again.",
      delete: "Delete",
