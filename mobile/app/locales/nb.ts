const nb = {
  ...
  auth: {
    ...
    resetLinkSent: "Vi har sendt en lenke for tilbakestilling av passord til {{email}}. Åpne den for å velge et nytt passord.",
  ...
  profile: {
    ...
    legal: {
      ...
      contactUnavailable: "Vi kunne ikke åpne e-postappen din. Du kan nå oss på {{email}}.",
      terms: {
  ...
  progress: {
    ...
    statsCardTitle: "Din fremgang",
    statsWorkouts: "Økter",
    statsEraPoints: "ERA-poeng",
    statsDayStreak: "Dagsrekke",
    statsLifetimeVolume: "Totalt volum",
    lifetimeVolume: {
      title: "Totalt livstidsvolum",
      planEyebrow: "{{gender}} {{level}}-plan",
      totalWeightLifted: "Totalt løftet vekt",
      kilograms: "Kilogram",
      equivalentTo: "Det tilsvarer",
      equivalentValue: "{{elephants}}, {{cars}} eller {{people}}",
      equivalentElephants_one: "{{value}} Elefant",
      equivalentElephants_other: "{{value}} Elefanter",
      equivalentCars_one: "{{value}} Bil",
      equivalentCars_other: "{{value}} Biler",
      equivalentPeople_one: "{{value}} Person",
      equivalentPeople_other: "{{value}} Personer",
      shareButton: "Del med venner",
      shareMessage: "Jeg har løftet {{volume}} kg totalt på ERA 💪",
    },
    ...
    photoPreview: {
      ...
      saveFailedTitle: "Kunne ikke lagre bildet",
      saveFailedMessage: "Noe gikk galt da bildet skulle klargjøres. Prøv igjen.",
      delete: "Slett",
