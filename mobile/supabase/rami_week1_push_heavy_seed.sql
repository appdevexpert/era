...
day_seed as (
  ...
  values
    ...
    ('2a87094c-260a-4a1b-95f6-7de8d5300202','2a87094c-260a-4a1b-95f6-7de8d5300001','2a87094c-260a-4a1b-95f6-7de8d5300101',2,2,'pull','Pull - Heavy','{"en":"Pull - Heavy","nb":"Pull - tung"}'::jsonb,'Week 1 - Tuesday','{"en":"Week 1 - Tuesday","nb":"Uke 1 - tirsdag"}'::jsonb,array['back','biceps'],75,100,false,2),
    ('2a87094c-260a-4a1b-95f6-7de8d5300203','2a87094c-260a-4a1b-95f6-7de8d5300001','2a87094c-260a-4a1b-95f6-7de8d5300101',3,3,'legs','Legs / Abs','{"en":"Legs / Abs","nb":"Bein / mage"}'::jsonb,'Week 1 - Wednesday','{"en":"Week 1 - Wednesday","nb":"Uke 1 - onsdag"}'::jsonb,array['legs','abs'],70,100,false,3),
    ('2a87094c-260a-4a1b-95f6-7de8d5300204','2a87094c-260a-4a1b-95f6-7de8d5300001','2a87094c-260a-4a1b-95f6-7de8d5300101',4,4,'shoulders','Shoulders / Neck','{"en":"Shoulders / Neck","nb":"Skuldre / nakke"}'::jsonb,'Week 1 - Thursday','{"en":"Week 1 - Thursday","nb":"Uke 1 - torsdag"}'::jsonb,array['shoulders','neck'],65,100,false,4),
    ...
    ('2a87094c-260a-4a1b-95f6-7de8d5300206','2a87094c-260a-4a1b-95f6-7de8d5300001','2a87094c-260a-4a1b-95f6-7de8d5300101',6,6,'legs','Legs - Volume','{"en":"Legs - Volume","nb":"Bein - volum"}'::jsonb,'Week 1 - Saturday','{"en":"Week 1 - Saturday","nb":"Uke 1 - lørdag"}'::jsonb,array['legs','abs'],70,100,false,6),
