...
const buttonVariants = cva(
  // cursor-pointer lives here, not only in globals.css: `render={<span/>}` and
  // `render={<div/>}` produce button-looking elements that no element-level
  // selector can reach, and a component should carry its own affordance.
